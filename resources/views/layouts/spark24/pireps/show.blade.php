...
@section('content')
  <div class="row">
    <div class="col-sm-8">
      <div>{{$pirep->airline->name}}</div>
      <h2>{{ $pirep->ident }} : {{ $pirep->dpt_airport_id }} -> {{ $pirep->arr_airport_id }}</h2>
    </div>
